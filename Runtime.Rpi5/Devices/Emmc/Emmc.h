...
constexpr UINT IRQF_MASK_ERROR			=(IRQF_ERR_CRC|IRQF_ERR_END|IRQF_ERR_INDEX|IRQF_ERR_DATA_TIMEOUT|IRQF_ERR_DATA_CRC|IRQF_ERR_DATA_END); // (0x7E0000)
constexpr UINT IRQF_MASK_DEFAULT		=(IRQF_CMD_DONE|IRQF_DATA_DONE|IRQF_BLOCK_GAP|IRQF_WRITE_RDY|IRQF_READ_RDY|IRQF_MASK_ERROR); // (0x7E0037)
...
constexpr UINT STATUS_DAT0				=(1<<20);
constexpr UINT STATUS_DAT1				=(1<<21);
constexpr UINT STATUS_DAT2				=(1<<22);
constexpr UINT STATUS_DAT3				=(1<<23);
constexpr UINT STATUS_CMD_LEVEL			=(1<<24);
constexpr UINT STATUS_DAT4				=(1<<25);
constexpr UINT STATUS_DAT5				=(1<<26);
constexpr UINT STATUS_DAT6				=(1<<27);
constexpr UINT STATUS_DAT7				=(1<<28);
constexpr UINT STATUS_DAT_LEVEL0		=(0xF<<20);
constexpr UINT STATUS_DAT_LEVEL1		=(0xF<<25);
