...
STRUCT_FIELD(SIZE_T, 8, IRQ_FRAME_, X19)
STRUCT_FIELD(SIZE_T, 8, IRQ_FRAME_, X20)
STRUCT_FIELD(SIZE_T, 8, IRQ_FRAME_, X21)
STRUCT_FIELD(SIZE_T, 8, IRQ_FRAME_, X22)
STRUCT_FIELD(SIZE_T, 8, IRQ_FRAME_, X23)
STRUCT_FIELD(SIZE_T, 8, IRQ_FRAME_, X24)
STRUCT_FIELD(SIZE_T, 8, IRQ_FRAME_, X25)
STRUCT_FIELD(SIZE_T, 8, IRQ_FRAME_, X26)
STRUCT_FIELD(SIZE_T, 8, IRQ_FRAME_, X27)
STRUCT_FIELD(SIZE_T, 8, IRQ_FRAME_, X28)
